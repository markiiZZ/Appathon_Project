      ...
      <Sky
        ...
        <nav id="nav-wrap">
          ...
          <ul id="nav" className="nav">
             <li className="current">{this.renderRedirect1()}<a type = "button" className="smoothscroll" href = '#' onClick = {this.setRedirect1}>Home</a></li>
            <li>{this.renderRedirect2()}<a 	type = "button" className="smoothscroll" href = '#' onClick = {this.setRedirect2}>Search</a></li>
          </ul>
        </nav>
